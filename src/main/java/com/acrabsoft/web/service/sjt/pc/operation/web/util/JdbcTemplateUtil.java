...
public class JdbcTemplateUtil {
    ...
    public static String getOracelToDate(Date nowDate) {
        return new StringBuilder("DATE_FORMAT('" ).append( DateUtil.toString( nowDate,DateUtil.DATE_LONG )  ).append( "','%Y-%m-%d %H:%i:%s')").toString();
    }
    ...
    public static String getOracelToChar(String columnName) {
        //:ss
        return new StringBuilder("DATE_FORMAT(" ).append( columnName  ).append( ",'yyyy-mm-dd hh24:mi') ").toString();
    }
    ...
    public static String getOracelToChar(String columnName,String dateFtm) {
        //:ss
        return new StringBuilder("DATE_FORMAT(" ).append( columnName  ).append( ",'"+dateFtm+"') ").toString();
    }
